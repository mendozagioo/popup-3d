...
function updateDrag(e) {
  ...
  if ((curPageIndex == 0 && adjustedPer > 0) || (curPageIndex == 2 && adjustedPer < 0)) {
    stopDrag();
    curPer = adjustedPer = 0;
    return;
  }
  ...
  if (curPageIndex == 0) {
    ...
    translateTransform = 'translate3d(' + (-200 + (200 * absPer)) + 'px, -55px, ' + (100 - (100 * absPer)) + 'px)';
  } else if (curPageIndex == 1 && adjustedPer > 0) {
    rotateTransform = 'rotateX(' + (90 - (61 * absPer)) + 'deg) rotateZ(' + (-8 * absPer) + 'deg)';
    translateTransform = 'translate3d(' + (-200 * absPer) + 'px, -55px, ' + (100 * absPer) + 'px)';
  } else if (curPageIndex == 1 && adjustedPer < 0) {
    rotateTransform = 'rotateX(' + (90 - (61 * absPer)) + 'deg) rotateZ(' + (-8 * absPer) + 'deg)';
    translateTransform = 'translate3d(' + (200 * absPer) + 'px, ' + (-120 * absPer) + 'px, ' + (100 * absPer) + 'px)';
  } else if (curPageIndex == 2 && adjustedPer > 0) {
    rotateTransform = 'rotateX(' + (29 + (61 * adjustedPer)) + 'deg) rotateZ(' + (-8 + (8 * adjustedPer)) + 'deg)';
    translateTransform = 'translate3d(' + (200 - (200 * adjustedPer)) + 'px, ' + (-120 + (120 * adjustedPer)) + 'px, ' + (100 - (100 * adjustedPer)) + 'px)';
  }
